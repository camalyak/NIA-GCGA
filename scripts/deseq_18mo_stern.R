...
dge <- read_csv("data/deseq_18mo_stern.csv")
png("images/18_mo_volcano.png", width = 7, height = 6, units = "in", res = 300)
make_volcano_fc(dge, "18 mo agonist", "Up / Downregulation in Agonist Relative to Saline (18 months)")
dev.off()
